...
@Component({
  ...
  template: `
    <svg
      ...
      role="img"
      aria-label="Vorrai AI"
      [class]="isResponding ? 'vorrai-logo responding' : 'vorrai-logo'"
      style="flex-shrink:0;overflow:visible"
    >
      <defs>
        <linearGradient [attr.id]="'bg-grad-'+uid" x1="0%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%"   stop-color="#004B3C" />
          <stop offset="50%"  stop-color="#003B2F" />
          <stop offset="100%" stop-color="#004B3C" />
        </linearGradient>
        <linearGradient [attr.id]="'filigree-grad-'+uid" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%"   stop-color="#FAF9F6" />
          <stop offset="50%"  stop-color="#FFFFFF" />
          <stop offset="100%" stop-color="#FAF9F6" />
        </linearGradient>
        <linearGradient [attr.id]="'filigree-dark-'+uid" x1="100%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%"   stop-color="#D6E2DA" />
          <stop offset="100%" stop-color="#FAF9F6" />
        </linearGradient>
        <linearGradient [attr.id]="'pillar-grad-'+uid" x1="0%" y1="0%" x2="100%" y2="0%">
          ...
          <stop offset="50%"  stop-color="#2E7D5B" />
      ...
      <polygon points="100,20 180,125 100,230 20,125"
               fill="none" stroke="#D6E2DA" stroke-width="0.5" stroke-opacity="0.4" />
      ...
      <path class="pillar-energy"
            ...
            stroke="#FAF9F6" stroke-width="3" stroke-linecap="round"
      ...
      <g>
        <path d="M 100 20 C 125 45, 115 75, 100 75 C 85 75, 75 45, 100 20 Z"
              fill="#002A21" stroke="#D6E2DA" stroke-width="1.5" />
        <polygon points="100,5 110,25 100,40 90,25"
                 fill="#003B2F" stroke="#D6E2DA" stroke-width="1" />
        <polygon points="100,10 105,25 100,35 95,25"
                 fill="#D6E2DA" opacity="0.8" />
        <circle cx="92" cy="55" r="4"
                fill="#FAF9F6" class="anim-eye anim-pulse-slow"
                [attr.filter]="'url(#glow-'+uid+')'" />
        <circle cx="108" cy="55" r="4"
                fill="#FAF9F6" class="anim-eye anim-pulse-slow"
                [attr.filter]="'url(#glow-'+uid+')'" />
        <circle cx="92"  cy="55" r="1.5" fill="#1F2933" />
        <circle cx="108" cy="55" r="1.5" fill="#1F2933" />
      </g>
