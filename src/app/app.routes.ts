...
export const routes: Routes = [
  ...
  { path: 'users/:userId/anamnesis', loadComponent: () => import('./pages/anamnesis/anamnesis').then(m => m.Anamnesis), canActivate: [authGuard] },
  ...
  { path: 'staff', loadComponent: () => import('./pages/staff/staff').then(m => m.Staff), canActivate: [authGuard] },
  { path: 'clinic-profile', loadComponent: () => import('./pages/clinic-profile/clinic-profile').then(m => m.ClinicProfileEditor), canActivate: [authGuard] },
